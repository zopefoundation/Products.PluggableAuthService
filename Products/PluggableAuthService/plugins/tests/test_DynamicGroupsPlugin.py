...
class DynamicGroupsPlugin(unittest.TestCase, IGroupsPlugin_conformance,
                          IGroupEnumerationPlugin_conformance):
    ...
    def test_addGroup_duplicate(self):
        ...
        self.assertRaises(KeyError, dpg.addGroup, 'everyone', 'python:False',
                          'other title', 'other descripton', False)
    ...
    def test_updateGroup_nonesuch(self):
        ...
        self.assertRaises(KeyError, dpg.updateGroup, 'everyone', 'title', True)
    ...
    def test_enumerateGroups_exact_one(self):
        ...
        # Because there is no proper REQUEST, the properties_url will be
        # incorrect. It should normally be
