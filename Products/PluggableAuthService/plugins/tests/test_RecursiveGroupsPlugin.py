...
class RecursiveGroupsPluginTests(unittest.TestCase, IGroupsPlugin_conformance):

    def _getTargetClass(self):

        from Products.PluggableAuthService.plugins.RecursiveGroupsPlugin import RecursiveGroupsPlugin  # NOQA
    ...
    def test_complex_flattening(self):
        ...
        user = DummyPrincipal('user1', ('dummy:group1', 'other_dummy:group3'))
    ...
    def test_cross_nested_flattening(self):
        ...
        user = DummyPrincipal('user1', ('dummy:group1', 'other_dummy:group2'))

        dgm.addPrincipalToGroup(user, 'group1')
        dgm.addPrincipalToGroup(DummyPrincipal('other_dummy:group1'), 'group1')
